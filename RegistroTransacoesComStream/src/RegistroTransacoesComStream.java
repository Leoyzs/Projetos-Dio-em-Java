...
public class RegistroTransacoesComStream {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Digite a quantidade total de transacoes: ");
        ...
        for (int i = 1; i <= quantidadeTransacoes; i++) {
            ...
            System.out.print("Tipo de transacao (D para deposito ou S para saque): ");
            ...
            if (tipoTransacao == 'd' || tipoTransacao == 's') {
                ...
                System.out.println("Tipo de transacao invalido. Utilize D para deposito ou S para saque.");
